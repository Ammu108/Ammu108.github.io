const education = [
  {
    ...
    duration: "2026 - 2028",
    detail: "Focused on AI & ML. full stack development, And Java Advanced",
    status: "Current%",
  },
  {
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base leading-relaxed text-white/60 md:text-lg">
              I am Aman Kumar, a frontend-focused developer while backend still learning.
              currently pursuing BCA in Greater Noida. I enjoy translating ideas into polished
              interfaces with fast performance, clear structure, and thoughtful user
              experience.
            </p>
          </div>
          ...
          <div className="space-y-5">
            {education.map((item) => (
              ...
              >
                ...
                <p className="relative z-10 mt-2 text-sm text-cyan-200/90">{item.institute}</p>
        ...
        <aside className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0c0d1c]/80 p-7 shadow-2xl shadow-[#7B61FF]/10">
          ...
          <div className="relative z-10 space-y-6">
            <div>
              ...
              <h3 className="mt-3 text-2xl font-semibold text-white">Aman Kumar</h3>
              <p className="mt-1 text-sm text-[#00E5FF]">Frontend Developer | React.js</p>
            </div>
