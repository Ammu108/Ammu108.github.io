        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-base leading-relaxed text-white/60 md:text-lg">
              My toolkit covers modern frontend development, design systems, and practical
              backend integration to move from idea to production quickly.
            </p>
          </div>
        </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start justify-between gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm leading-relaxed text-white/55">{skill.subtitle}</p>
                  </div>
